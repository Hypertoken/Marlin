...
#define STRING_CONFIG_H_AUTHOR "(Hypertoken)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "VIKI"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 1000, 1000, 20, 20 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40.6, -7.3, 0 }
