...
#define STRING_CONFIG_H_AUTHOR "(Hypertoken, SKR_1.4_T)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "UncleBOB"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 176.42
  #define DEFAULT_bedKi 33.16
  #define DEFAULT_bedKd 625.69
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -35, 20, -2.43 }
